...
import static WebOperation.uploadServlet.access;
import static WebOperation.uploadServlet.missmatch;
import ava.ANTLR;
import ava.Student;
 ...
 * @author epsilon
 */
@WebServlet(name = "fileManage", urlPatterns = {"/fileManage"})
...
public class fileManage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Something happend with uploading the grammar!");
        }
...
//        try {
            ...
            dispatch = "Submission.jsp";
//        } catch (Exception e) {
//            System.out.println("Something happened with processor method!");
